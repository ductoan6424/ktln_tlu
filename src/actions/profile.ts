...
function getProfileValidationMessage() {
  return "Há» vĂ  tĂªn pháº£i cĂ³ tá»« 2 Ä‘áº¿n 100 kĂ½ tá»±."
}
...
export async function updateUserProfile(
  ...
  if (authError || !userData.user) {
    return errorResult("Báº¡n cáº§n Ä‘Äƒng nháº­p Ä‘á»ƒ thá»±c hiá»‡n", "UNAUTHORIZED")
  }
  ...
  try {
    ...
    if (result.error) {
      return errorResult(
        "KhĂ´ng thá»ƒ cáº­p nháº­t há»“ sÆ¡. Vui lĂ²ng thá»­ láº¡i.",
