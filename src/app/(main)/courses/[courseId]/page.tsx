...
const COURSES: Record<string, { name: string; subject: string; studentCount: number; lecturer: string; coverImage: string }> = {
  cs101: { name: "Lập trình Python", subject: "CS101", studentCount: 45, lecturer: "TS. Nguyễn Văn Minh", coverImage: "https://images.unsplash.com/photo-1515879218367-8466d910aaa4?w=1200&h=400&fit=crop" },
  cntt: { name: "Công nghệ thông tin", subject: "CNTT", studentCount: 120, lecturer: "TS. Trần Văn Minh", coverImage: "https://images.unsplash.com/photo-1504639725590-34d0984388bd?w=1200&h=400&fit=crop" },
  ktso: { name: "Kỹ thuật số", subject: "KTSO", studentCount: 30, lecturer: "ThS. Lê Hoàng Nam", coverImage: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=1200&h=400&fit=crop" },
  java: { name: "Lập trình Java", subject: "CS102", studentCount: 80, lecturer: "TS. Phạm Đình Khoa", coverImage: "https://images.unsplash.com/photo-1627398242454-45a1465c2479?w=1200&h=400&fit=crop" },
}
...
export default function CourseDetailPage() {
  ...
  const course = COURSES[courseId] ?? { name: "Môn học", subject: "", studentCount: 0, lecturer: "Chưa có", coverImage: "" }
